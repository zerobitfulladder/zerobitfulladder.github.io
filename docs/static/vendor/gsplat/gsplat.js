...
class Lt {
  constructor(t, n, i = 0.5, e = 0.5, A = 5, o = !0, s = new R()) {
    ...
    this.getState = () => ({ alpha: I, beta: d, radius: a, target: { x: Q.x, y: Q.y, z: Q.z } });
    this.setState = (o) => { if (o.alpha !== void 0) I = o.alpha; if (o.beta !== void 0) d = o.beta; if (o.radius !== void 0) a = o.radius; if (o.target) Q = new R(o.target.x, o.target.y, o.target.z); };
